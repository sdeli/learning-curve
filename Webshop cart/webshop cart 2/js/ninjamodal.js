(function(){
	...
	var ModalObject={
		...
		triggerButton: document.querySelectorAll("#OpenShoppingCart")[0],

		pushBackButton: document.querySelectorAll("#close-modal")[0],
		...
		movementFunctions: {
				...
				dropDownFunction: function(){
					ModalObject.triggerButton.addEventListener("click", function(){
						...
						if( ModalObject.modalWindow.hasAttribute("class")===false && ModalObject.movementFunctions.checkValues()<=-405 ){
				...
				pushBackFunction: function(){
					ModalObject.pushBackButton.addEventListener("click", function(){
						...
						if(ModalObject.modalWindow.hasAttribute("class")===false && checker<=50 && checker>=50){
							...
							setTimeout(function(){
							 ModalObject.modalWindow.style.top="-405px"; 
							 ModalObject.modalWindow.removeAttribute("class");
							}, 1000);
